    ...
    const loadTimer = window.setTimeout(() => {
      try {
        ...
        if (saved) {
          ...
          if (Array.isArray(parsed.accounts)) setAccounts(parsed.accounts.map((account) => ({ ...account, interestFee: Number.isFinite(account.interestFee) ? account.interestFee : 0, payoffMode: account.payoffMode === "minimum-only" ? "minimum-only" : "priority" })));
  ...
  return <div className="app-shell">
    ...
    <main className="main-area">
      ...
      <div className="page-body">
        ...
        {page === "plan" && <PayoffPlanPage accounts={accounts} plan={plan} extra={extra} surplus={monthlySurplus} strategy={strategy} onExtra={setExtra} onStrategy={setStrategy} onAccounts={() => setPage("accounts")} onEditAccount={openEdit}/>}
